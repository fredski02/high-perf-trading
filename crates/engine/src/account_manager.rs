...
impl AccountManager {
    ...
    pub fn apply_fill(&mut self, account_id: AccountId, side: Side, price: i64, qty: i64) {
...
mod tests {
    ...
    fn test_risk_check_order_size() {
        ...
        // Exceeds limit
        assert_eq!(mgr.check_risk(1, Side::Buy, 51), Err(RejectReason::Risk));
    }
    ...
    fn test_risk_check_position_limit() {
        ...
        assert_eq!(mgr.check_risk(1, Side::Buy, 20), Err(RejectReason::Risk));
    }
